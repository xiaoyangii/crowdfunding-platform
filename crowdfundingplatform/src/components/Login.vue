<template>
  <div class="login-wrap">
    <el-form class="login-container">
      ...
      <el-form-item>
        <el-input type="text" placeholder="用户账号" v-model="userId" autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item>
        <el-input type="password" placeholder="用户密码" v-model="userPassword" autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item>
