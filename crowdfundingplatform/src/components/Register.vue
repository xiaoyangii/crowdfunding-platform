  ...
  <div class="login-wrap">
    <el-form class="login-container" :model="form" :rules="rules" ref="form">
      ...
      <el-form-item prop="userName">
        <el-input type="text" placeholder="用户姓名" v-model="form.userName" autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item prop="userID">
        <el-input type="text" placeholder="用户账号" v-model.number="form.userID" autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item prop="userPassword">
        <el-input type="password" placeholder="用户密码" v-model="form.userPassword" autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item prop="userPassword1">
        <el-input type="password" placeholder="确认密码" v-model="form.userPassword1" autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item prop="userPhone">
        <el-input type="text" placeholder="电话号码" v-model.number="form.userPhone" autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item>
      ...
      return {
        ...
        rules: {
          userID: [
            ...
            { pattern: /^\d{4,10}$/, message: '长度在 4 到 10 个数字', trigger: 'blur' }
          ],
          userName: [
    ...
    methods: {
      async doRegister() {
        ...
        let params = {
          ...
          contactInformation: this.form.userPhone.toString(),
          userRight: this.form.userRight
        }
        await request.post('/enroll', params)
        .then(res => {
          if(res.data.code==1) {
            this.$message({
